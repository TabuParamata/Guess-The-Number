...
{
    document.querySelector("#hint").innerHTML = "INFANT";    
}
...
{
    document.querySelector("#hint").innerHTML = "ADOLESCENT";   
}
...
else if(randomselect > 70 && randomselect <= 100)
{
    document.querySelector("#hint").innerHTML = "INVALID AGE";   
}

function myfunction()
{
    let myguess = document.querySelector("#num").value;
    console.log(`${myguess}------> THIS IS THE NUMBER I GUESS`)
    if(randomselect==myguess)
    {
        document.querySelector("#hint").innerHTML = "YOU WON THE GAME";
        ...
        // document.querySelector('#baloon').style.display = 'block';
    ...
    else
    {
       ...
       {
        document.querySelector("#score").innerHTML = changescore;
        document.querySelector("#hint").innerHTML = "GAME OVER TRY AGAIN";
        document.querySelector("#guessbox").disabled = "true";
